...
@pytest.mark.parametrize("mode", [LaplacianScheme.Naive, LaplacianScheme.Dot, LaplacianScheme.Default])
def test_laplacianPositionJVP_rejects_nonBrookshaw_modes(mode):
    positions, p0, domain, adjacency, props, qv, rv = _minimal_case()
