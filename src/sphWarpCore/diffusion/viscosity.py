...
from ..dataTypes import AdjacencyList, AdjacencyListWarp, DomainDescription, PointCloud
from ..math import *
from ..kernels import *
...
def computePi_actual(
    ...
    kernelProperties.kernelFunction : wp.int32,
    ...
    # xi = sphKernelScale(kernelProperties.kernelFunction, domainState.dim) if viscosityParams.correctXi else scalar_t(1.0)
    xi = sphKernel_xi(kernelProperties.kernelFunction, domainState.dim) if viscosityParams.correctXi else scalar_t(1.0)
...
def computePiViscosityKernel_Func(   
    ...
    for neighborIndex in range(numNeighs):
        ...
        kernelGradient = sphKernelGradient(xi, positions[j], hi, supports[j], kernelProperties.kernelFunction, mode_uint, periodicity, domainMin, domainMax)
...
def computeViscosityKernel(
    ...
    mode_uint: wp.uint32, kernelProperties.kernelFunction : wp.int32,
    ...
    outputValues[i] = computePiViscosityKernel_Func(
        ...
        mode_uint, kernelProperties.kernelFunction,
