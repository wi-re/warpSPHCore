...
def computeSPHLaplacian_warpBackend(
    ...
    if scatteredQuantities is not None:
        raise NotImplementedError(
            "Pre-scattered quantities are no longer supported by the Laplacian operator: "
    ...
    return _computeSPHLaplacian_stateBackend(
        queryParticles, referenceParticles, domain, mode, kernel, gradientMode, laplacianMode, positiveDivergence, operationMode,
