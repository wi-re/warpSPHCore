...
scenario does not transfer to another; re-run rather than extrapolate.
    ...
    python scripts/benchmarks/bench_real_workload.py --nx 39 64 128 229 384
    python scripts/benchmarks/bench_real_workload.py --nx 39 64 128 229 384 --no-forcing
    python scripts/benchmarks/bench_real_workload.py --nx 39 128 229 384 --hatches --no-forcing

    # what cases are available, and the raw profiler event names behind the buckets
    python scripts/benchmarks/bench_real_workload.py --listCases
    python scripts/benchmarks/bench_real_workload.py --dump 128 --top 40
