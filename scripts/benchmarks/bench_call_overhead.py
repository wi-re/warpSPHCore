...
``scripts/diagnostics/operation_matrix.py`` (forward-value correctness) or the ``gradcheck``
...
Usage:
    python scripts/benchmarks/bench_call_overhead.py
    python scripts/benchmarks/bench_call_overhead.py --ns 2000 20000 200000 --dims 2
    python scripts/benchmarks/bench_call_overhead.py --grad --ns 20000
    python scripts/benchmarks/bench_call_overhead.py --record docs/regression/bench_call_overhead_baseline.md
"""
