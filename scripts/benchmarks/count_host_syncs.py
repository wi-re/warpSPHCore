...
no profiler. Sites are reported as `file:line (function)`, ready to act on.
    ...
    python scripts/benchmarks/count_host_syncs.py                     # default scenario
    python scripts/benchmarks/count_host_syncs.py --nx 229 --steps 10
    python scripts/benchmarks/count_host_syncs.py --case sod3d --preset none
    python scripts/benchmarks/count_host_syncs.py --filter warpSPHCore   # only this repo's sites
"""
