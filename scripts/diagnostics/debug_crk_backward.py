...
Usage:
    python scripts/diagnostics/debug_crk_backward.py                  # both cases, anomaly detection on
    python scripts/diagnostics/debug_crk_backward.py --case line       # only the line-of-7 case
    python scripts/diagnostics/debug_crk_backward.py --no-anomaly      # let the raw error surface unshaped
"""
...
_sys.path.insert(0, str(_Path(__file__).resolve().parent.parent / "gradcheck"))
# ^ _gradcheck_common.py lives in scripts/gradcheck/, this script does not
