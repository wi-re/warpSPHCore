...
Usage:
    ...
    python scripts/diagnostics/operation_matrix.py --device cpu --threshold 0.3
    python scripts/diagnostics/operation_matrix.py --device both --verbose
    python scripts/diagnostics/operation_matrix.py --precision float64 --dim 3
"""
